...
public class MealTestData {
    ...
    public static final List<MealTo> MEALS1 = MealsUtil.getWithExcess(MEALS, SecurityUtil.authUserCaloriesPerDay());
    ...
    public static <T> ResultMatcher contentJson(Iterable<T> expected) {
